...
mainConnection = sqlite3.connect('example.db')
...
def cleanTable():
    temporalConnection = sqlite3.connect('example.db')
...
def handle_client(conn, p): 
    ...
    if p == 0:
        connection1= sqlite3.connect('example.db')                            # We create two connections and cursors, to be able to execute sqlite commands in both threads
        cursor1= connection1.cursor()
    else:
        connection2= sqlite3.connect('example.db')
...
#mainCursor.execute("DELETE FROM gameTable")
